    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <header className="relative overflow-hidden py-20 md:py-32 text-white">
        <div 
          ...
          style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1556656793-08538906a9f8?w=1920&q=80)' }}
        ></div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-base md:text-lg text-white/85 max-w-3xl mx-auto leading-relaxed">
              Martha Stewart and Snoop Dogg crack weed jokes while promoting unlimited data
            </p>
          </div>
        </div>
      </header>
            ...
            <CardContent className="space-y-4 text-base md:text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
                <div className="text-center p-4 bg-[#E32636]/5 rounded-lg border border-[#E32636]/20">
                  ...
                  <p className="text-xl font-bold text-[#E32636]">2017</p>
                </div>
                <div className="text-center p-4 bg-[#E32636]/5 rounded-lg border border-[#E32636]/20">
                  <p className="text-sm text-muted-foreground mb-1">Brand</p>
                  <p className="text-xl font-bold text-[#E32636]">T-Mobile</p>
                </div>
                <div className="text-center p-4 bg-[#FFD700]/20 rounded-lg border border-[#FFD700]/40">
                  ...
                  <p className="text-sm font-bold text-[#E32636]">Publicis Seattle</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="mb-16">
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <p className="text-muted-foreground text-base md:text-lg">Publicis Seattle (Seattle, USA)</p>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex justify-between items-start border-b border-border pb-2">
                    ...
                    <span className="text-right text-sm md:text-base">T-Mobile</span>
                  </div>
                  <div className="flex justify-between items-start border-b border-border pb-2">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-start border-b border-border pb-2">
                    ...
                    <span className="text-right text-sm md:text-base">Publicis Seattle</span>
                  </div>
                </div>
              </div>
            </CardContent>
