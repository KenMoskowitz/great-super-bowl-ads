    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <header className="relative overflow-hidden py-20 md:py-32 text-white">
        <div 
          ...
          style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1511688878353-3a2f5be94cd7?w=1920&q=80)' }}
        ></div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-base md:text-lg text-white/85 max-w-3xl mx-auto leading-relaxed">
              Red M&M tears off its shell and dances to "Sexy and I Know It" by LMFAO
            </p>
          </div>
        </div>
      </header>
            ...
            <CardContent className="p-0">
              <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                <iframe
                  ...
                  src="https://www.youtube.com/embed/WK7lIjFsGvg"
            ...
            <CardContent className="space-y-4 text-base md:text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
                <div className="text-center p-4 bg-[#E32636]/5 rounded-lg border border-[#E32636]/20">
                  ...
                  <p className="text-xl font-bold text-[#E32636]">2012</p>
                </div>
                <div className="text-center p-4 bg-[#E32636]/5 rounded-lg border border-[#E32636]/20">
                  <p className="text-sm text-muted-foreground mb-1">Brand</p>
                  <p className="text-xl font-bold text-[#E32636]">M&M's (Mars)</p>
                </div>
                <div className="text-center p-4 bg-[#FFD700]/20 rounded-lg border border-[#FFD700]/40">
                  ...
                  <p className="text-sm font-bold text-[#E32636]">BBDO New York</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="mb-16">
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <p className="text-muted-foreground text-base md:text-lg">BBDO New York (New York, USA)</p>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex justify-between items-start border-b border-border pb-2">
                    ...
                    <span className="text-right text-sm md:text-base">M&M's (Mars)</span>
                  </div>
                  <div className="flex justify-between items-start border-b border-border pb-2">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-start border-b border-border pb-2">
                    ...
                    <span className="text-right text-sm md:text-base">BBDO New York</span>
                  </div>
                </div>
              </div>
            </CardContent>
